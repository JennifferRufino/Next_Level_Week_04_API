...
```bash
- git clone https://github.com/JennifferRufino/Next_Level_Week_04_API.git
- cd api
```
...
<h4 align="center">
    Feito com 💜 by <a href="linkedin.com/in/jenniffer-rufino-3323521ab" target="_blank">Jenniffer Rufino</a>
</h4>